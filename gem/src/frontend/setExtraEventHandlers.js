...
(function() {
  define(["jquery", "frontend/addTextComment", "frontend/updateSearchResults", "frontend/settings", "frontend/clearAll"], function($, addTextComment, updateSearchResults, settings, clearAll) {
    return function() {
      ...
      $("#extra-uncertainties").click(function() {
        ...
        return settings.set("assumeZeroUncertainty", !settings.get("assumeZeroUncertainty"));
      });
