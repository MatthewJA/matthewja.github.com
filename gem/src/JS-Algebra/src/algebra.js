...
(function() {
  var AlgebraException, Constant, Equation, Variable, exportGlobals;

  AlgebraException = (function() {
  ...
  exportGlobals = function() {
    var root, topRoot;
    topRoot = typeof exports !== "undefined" && exports !== null ? exports : this;
    topRoot.algebra = {};
    root = topRoot.algebra;
    root.Variable = Variable;
    root.Constant = Constant;
    root.Equation = Equation;
    return root.AlgebraException = AlgebraException;
  };
